...
/*   Updated: 2016/04/10 06:14:53 by jbahus           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	e->mlx.data[j * e->mlx.sizeline + i * (e->mlx.bpp / 8) + 0] = (int)e->pix_color.blue;
	e->mlx.data[j * e->mlx.sizeline + i * (e->mlx.bpp / 8) + 1] = (int)e->pix_color.green;
	e->mlx.data[j * e->mlx.sizeline + i * (e->mlx.bpp / 8) + 2] = (int)e->pix_color.red;
}
